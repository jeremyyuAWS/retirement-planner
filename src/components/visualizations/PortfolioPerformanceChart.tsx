    ...
    if (canvasRef.current) {
      ...
      if (context) {
        ...
        for (let i = 0; i <= numHorizontalLines; i++) {
          ...
          // Draw value labels
          const value = minValue + (i * range / numHorizontalLines);
          context.fillStyle = '#6b7280';
          context.font = '10px Arial';
          context.textAlign = 'right';
          context.fillText(`$${Math.round(value).toLocaleString()}`, padding - 5, y + 3);
        }
        
        // Draw vertical grid lines and year labels
        data.forEach((point, index) => {
          ...
          context.fillText(point.year.toString(), x, height - padding + 15);
        });
